...
defalut parametert value
def check(name,ending="Thanks sir"):
    print(f"Good morning, {name}")
    print(ending)
check("Sushmita","thanks")
check("Kashyap")

def greet(name="Sushmita"):
    print(f"Good morning, {name}") # take the default name sammu into the output 
greet()
greet("Sammu")
